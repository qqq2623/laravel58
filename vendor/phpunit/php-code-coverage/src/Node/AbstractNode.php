 ...
 */
public
function getTestedClassesPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getTestedTraitsPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getTestedClassesAndTraitsPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getTestedFunctionsPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getTestedMethodsPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getTestedFunctionsAndMethodsPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getLineExecutedPercent(bool $asString = true) {
	return Util::percent(
 ...
 */
public
function getNumClassesAndTraits(): int {
 ...
 */
public
function getNumTestedClassesAndTraits(): int {
 ...
 */
public
function getClassesAndTraits(): array {
 ...
 */
public
function getNumFunctionsAndMethods(): int {
 ...
 */
public
function getNumTestedFunctionsAndMethods(): int {
 ...
 */
public
function getFunctionsAndMethods(): array {
