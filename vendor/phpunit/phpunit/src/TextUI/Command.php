...
class Command {
	 ...
	 */
	protected function handleLoader(string $loaderClass, string $loaderFile = ''):
 ...
 */
protected
function handlePrinter(string $printerClass, string $printerFile = '') {
 ...
 */
protected
function handleBootstrap(string $filename): void {
	try {
 ...
 */
protected
function handleCustomTestSuite(): void {
}

private
function printVersionString(): void {
...
private
function exitWithErrorMessage(string $message): void {
	$this->printVersionString();
...
private
function handleExtensions(string $directory): void {
...
private
function handleListGroups(TestSuite $suite, bool $exit): int {
	$this->printVersionString();
...
private
function handleListSuites(bool $exit): int {
	$this->printVersionString();
...
private
function handleListTests(TestSuite $suite, bool $exit): int {
	$this->printVersionString();
...
private
function handleListTestsXml(TestSuite $suite, string $target, bool $exit): int {
	$this->printVersionString();
...
private
function handleOrderByOption(string $value): void {
