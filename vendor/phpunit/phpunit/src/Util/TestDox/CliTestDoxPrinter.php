...
class CliTestDoxPrinter extends ResultPrinter {
	...
	private function formatTestSuiteHeader(
    ...
    public function printResult(TestResult $result): void {
        ...
        protected function printHeader(): void {
	        $this->write("\n" . Timer::resourceUsage() . "\n\n");
        }?string $lastClassName, string $className, string $msg): string
    {
...
private
function getFormattedAdditionalInformation(string $resultMessage, bool $verbose): string {
	if ($resultMessage === '') {
		return '';
	}
...
private
function printNonSuccessfulTestsSummary(int $numberOfExecutedTests): void {
...
private
function getEmptyTestResult(): array {
	return [
		'className' => '',
		'testName'  => '',
		'message'   => '',
