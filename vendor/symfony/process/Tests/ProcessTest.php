...
class ProcessTest extends TestCase {
	 ...
	 * @return Process
	 */
	private function getProcess($commandline, string $cwd = null, array $env = null, $input = null,
...
private
function getProcessForCode(string $code, string $cwd = null, array $env = null, $input = null, ?int $timeout = 60): Process
    {
