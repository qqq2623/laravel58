 ...
 */
public
function addDefaults(array $defaults) {
 ...
 */
public
function setRequirement($key, $regex) {
	$this->requirements[$key] = $this->sanitizeRequirement($key, $regex);
	$this->compiled           = null;
...
private
function sanitizeRequirement($key, $regex) {
	if (!\is_string($regex)) {
