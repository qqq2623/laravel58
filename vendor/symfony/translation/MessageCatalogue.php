 ...
 */
public
function getMetadata($key = '', $domain = 'messages') {
	if ('' == $domain) {
 ...
 */
public
function setMetadata($key, $value, $domain = 'messages') {
 ...
 */
public
function deleteMetadata($key = '', $domain = 'messages') {
	if ('' == $domain) {
		$this->metadata = [];
	} elseif ('' == $key) {
 ...
 */
private
function addMetadata(array $values) {
