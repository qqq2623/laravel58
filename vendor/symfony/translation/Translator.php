 ...
 */
public
function addResource($format, $resource, $locale, $domain = null) {
	if (null === $domain) {
		$domain = 'messages';
	}
 ...
 */
public
function setFallbackLocales(array $locales) {
 ...
 */
public
function getCatalogue($locale = null) {
	if (null === $locale) {
 ...
 */
protected
function initializeCatalogue($locale) {
	$this->assertValidLocale($locale);
...
private
function initializeCacheCatalogue(string $locale): void {
	if (isset($this->catalogues[$locale])) {
...
private
function dumpCatalogue($locale, ConfigCacheInterface $cache): void {
	$this->initializeCatalogue($locale);
...
private
function getFallbackContent(MessageCatalogue $catalogue): string {
	$fallbackContent    = '';
	$current            = '';
...
private
function getCatalogueCachePath($locale) {
 ...
 */
protected
function doLoadCatalogue($locale): void {
...
private
function loadFallbackCatalogues($locale): void {
...
protected
function computeFallbackLocales($locale) {
...
private
function getAllMessages(MessageCatalogueInterface $catalogue): array {
	$allMessages = [];
